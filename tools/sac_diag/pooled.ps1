...
Pool '^shape-new-k0'                '3) shaping & F1 baseline: new, shape=0'
...
Pool '^f1-t01-i08'                  'F1) tau=0.01 / every 8'
Pool '^f1-t05-i08'                  'F1) tau=0.05 / every 8'
Pool '^f1-hard-i256'                'F1) hard copy / every 256'
Pool '^f1-f2-s'                     'F1+F2) entropy out of target'
Pool '^f1-f2-f3'                    'F1+F2+F3) + Hbar from slots'
